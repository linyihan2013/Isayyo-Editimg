...
public class TortureDragImageView extends ImageView {
	...
	public TortureDragImageView(Context context) {
		super(context);
	 ...
	 */
	public TortureDragImageView(Context context, AttributeSet paramAttributeSet) {
