...
public class TortureMyEditText extends EditText {
	float textsize = 54;
	float widthScreen = 1080;
	float minTextSize = 28;
	float toTextSize = 28;

	public TortureMyEditText(Context context, AttributeSet attrs, int defStyle) {
		...
		minTextSize = 28*widthScreen/1080;
	}

	public TortureMyEditText(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
		initialise();
		width = TortureImageViewActivity.content.getWidth();
		height = TortureImageViewActivity.content.getHeight();
		textsize = getTextSize();
		widthScreen = TouchImageViewActivity.widthScreen;
		minTextSize = 28*widthScreen/1080;
	}

	public TortureMyEditText(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
		initialise();
		width = TortureImageViewActivity.content.getWidth();
		...
		textsize = getTextSize();
		widthScreen = TouchImageViewActivity.widthScreen;
		minTextSize = 26*widthScreen/1080;
	}
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		switch (event.getAction() & MotionEvent.ACTION_MASK) {
			...
			case MotionEvent.ACTION_UP:
				...
				for (int i = 1; i < TortureImageViewActivity.content.getChildCount(); i++) {
					FrameLayout view = (FrameLayout)TortureImageViewActivity.content.getChildAt(i);
					if (view != layout) {
